...
class LifeState:
    ...
    physiological_rhythm: PhysiologicalRhythm = field(
        default_factory=PhysiologicalRhythm
    )
    summary: str = ""
    updated_at: str = ""
    source: str = ""
    ...
    def from_value(value: Any) -> "LifeState | None":
        ...
        return LifeState(
            ...
            physiological_rhythm=PhysiologicalRhythm.from_value(
                value.get("physiological_rhythm")
            ),
