...
from ..prompts import CORE_MEMORY_RULES, cache_friendly_prompt, json_output_section
...
{{
  ...
  "preference_points": [
    {{"category": "activity|outfit|social|sleep|place|style|other", "content": "可复用偏好", "weight": 0.1-2.0, "evidence": "来自今天哪件事"}}
  ],
