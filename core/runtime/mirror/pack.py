    ...
    async def _gather_life_context_snapshot(
        ...
        *,
        ...
        base_tasks: list[Any] = [
            ...
            self.archive.get_emotion_arcs(limit=4, scope=experience_scope),
            self.archive.get_physiological_rhythm_logs(limit=3),
            self.archive.get_physiological_rhythm_trend(days=7, limit=6),
