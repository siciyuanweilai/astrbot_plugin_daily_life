...
STORAGE_CATEGORIES: dict[str, StorageCategory] = {
    ...
    "workshop": StorageCategory(
        key="workshop",
        label="素材工坊",
        description="自定义素材、发型组、周模板和内置素材启停状态。",
        tables=(
            "custom_catalog_items",
            "custom_hair_styles",
            "custom_hair_options",
            "builtin_item_states",
            "custom_week_templates",
            "custom_week_template_goals",
            "custom_week_template_hints",
            "custom_week_template_suggestions",
            "custom_week_template_tags",
        ),
        clear_order=(
            "custom_hair_options",
            "custom_hair_styles",
