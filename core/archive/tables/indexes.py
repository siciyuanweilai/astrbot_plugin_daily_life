...
CREATE INDEX IF NOT EXISTS idx_reverse_prompts_fingerprint ON reverse_prompts(scope, source_image_hash, profile, source_prompt, id DESC);
...
CREATE INDEX IF NOT EXISTS idx_memory_vectors_updated ON memory_vectors(updated_at DESC);
